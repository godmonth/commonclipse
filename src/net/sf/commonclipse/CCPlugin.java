...
public class CCPlugin extends AbstractUIPlugin
{
    ...
    public static final String P_COMMONS_VERSION = "commons_version"; //$NON-NLS-1$
    ...
    public static final String COMMONS_VERSION = "commons_version";
    public static final String COMMONS_VERSION_3 = "commons_version_3";
