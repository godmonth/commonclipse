 ...
 * @author fgiust
 * @version $Revision: 65 $ ($Author: fgiust $)
 */
...
public class CCPreferencePage extends TabbedFieldEditorPreferencePage implements IWorkbenchPreferencePage
{
    ...
    public void createFieldEditors()
    {
        ...
        String[] styles = new String[]{"ToStringStyle.DEFAULT_STYLE", //$NON-NLS-1$
            "ToStringStyle.MULTI_LINE_STYLE", //$NON-NLS-1$
            "ToStringStyle.NO_FIELD_NAMES_STYLE", //$NON-NLS-1$
            "ToStringStyle.SIMPLE_STYLE",
        	"ToStringStyle.SHORT_PREFIX_STYLE"}; //$NON-NLS-1$
        ...
        addTab(CCMessages.getString("preference.tab.apachepackage")); //$NON-NLS-1$

        addField(new RadioGroupFieldEditor(
            CCPlugin.P_COMMONS_VERSION,
            CCMessages.getString("preference.apachepackage.version"), 1, new String[][]{ //$NON-NLS-1$
            {CCMessages.getString("preference.apachepackage.lang"), CCPlugin.COMMONS_VERSION}, //$NON-NLS-1$
                {CCMessages.getString("preference.apachepackage.lang3"), //$NON-NLS-1$
                    CCPlugin.COMMONS_VERSION_3}},
            getFieldEditorParent(),
            true));
