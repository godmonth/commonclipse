...
public final class ToStringGenerator extends Generator
{
    ...
    private static final String BUILDER_CLASS_3 = "org.apache.commons.lang3.builder.ToStringBuilder"; 
    private static final String STYLE_PREFIX = "org.apache.commons.lang.builder."; 
    private static final String STYLE_PREFIX_3 = "org.apache.commons.lang3.builder."; 
    /**
    ...
    {
    	if(CCPluginPreferences.getPreferences().useCommons3()){	
    		type.getCompilationUnit().createImport(BUILDER_CLASS_3, null, null);
    	} else {
        ...
        {
        	if(CCPluginPreferences.getPreferences().useCommons3()){	
                type.getCompilationUnit().createImport(STYLE_PREFIX_3 + 
                        CCPluginPreferences.getPreferences().getToStringStyleQualifiedClass(),
                        null,
                        null);
        	} else {
                type.getCompilationUnit().createImport(STYLE_PREFIX +
                        CCPluginPreferences.getPreferences().getToStringStyleQualifiedClass(),
                        null,
                        null);
        	}
